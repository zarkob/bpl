    class BpmnLiteParser {
      ...
      parseGatewayBranch(line, branchChar) {
        ...
        // Note: Connectivity edges are created by ConnectivityEngine during connectTasks()
      ...
      connectTasks() {
        if (typeof ConnectivityEngine !== 'function') {
          throw new Error('ConnectivityEngine is required but not loaded');
        }
        const engine = new ConnectivityEngine(this);
        engine.establishConnections();
      }
